...
public class HoaDonNhapBUS {
	...
	public ArrayList<HoaDonNhapDTO> search(String type, String keyword, LocalDate _ngay1, LocalDate _ngay2, int _tong1,
			int _tong2) {
		...
		for (int i = result.size() - 1; i >= 0; i--) {
			...
			Boolean ngayKhongThoa = (_ngay1 != null && ngaylap.isBefore(_ngay1))
					|| (_ngay2 != null && ngaylap.isAfter(_ngay2));
