...
public class KhachHangDTO {
	...
	public KhachHangDTO(String IDKhachHang, String HoKhachHang, String TenKhachHang, String Gmail, String GioiTinh,
			String SoDienThoai, float TongChiTieu, String TrangThai) {
	...
	public KhachHangDTO(String IDKhachHang, String HoKhachHang, String TenKhachHang, String Gmail, String GioiTinh,
			String SoDienThoai, float TongChiTieu) {
		this.IDKhachHang = IDKhachHang;
		this.HoKhachHang = HoKhachHang;
		this.TenKhachHang = TenKhachHang;
		this.Gmail = Gmail;
