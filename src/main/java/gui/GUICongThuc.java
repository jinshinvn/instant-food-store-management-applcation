			...
			if (i == 1) {
				...
				ThemMonAn.addActionListener((ActionEvent ae) -> {
					...
					try {
						...
						java.util.logging.Logger.getLogger(GUIBanHang.class.getName())
				...
				if (a == JOptionPane.YES_OPTION) {
					if (checkTextThem(txt_CongThuc_Them[1].getText(), txt_CongThuc_Them[2].getText())) {
						CongThucDTO DTO = new CongThucDTO(txt_CongThuc_Them[0].getText(),
								txt_CongThuc_Them[1].getText(), txt_CongThuc_Them[3].getText(), "Hiện");
	...
	private void Sua_Frame() {
		...
		Luu.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent evt) {
				...
				if (a == JOptionPane.YES_OPTION) {
					if (checkTextSua(txt_CongThuc_Sua[1].getText(), txt_CongThuc_Sua[3].getText())) {
...
//        if (option == JOptionPane.YES_OPTION) {
		...
		CongThucDTO DTO = new CongThucDTO(txt_CongThuc_Sua[0].getText(), txt_CongThuc_Sua[1].getText(),
...
//        }
	...
	public void docDB() {
		...
		if (CongThucBUS.CT == null) {
			try {
				...
				java.util.logging.Logger.getLogger(GUICongThuc.class.getName()).log(java.util.logging.Level.SEVERE,
						null, ex);
			}
		}
	...
	public boolean checkTextThem(String MaMonAn, String moTaCongThuc) {
		...
		if (MaMonAn.equals("") || moTaCongThuc.equals("")) {
