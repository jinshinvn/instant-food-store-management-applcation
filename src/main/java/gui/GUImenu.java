...
public class GUImenu extends JFrame {
	...
	private String arr_listmotaQuyen[] = { "QLBanHang", "QLNhapHang", "QLMonAn", "QLNguyenLieu", "QLCongThuc",
			"QLHoaDon", "QLHDNhap", "QLKhuyenMai", "QLKhachHang", "QLNhanVien", "QLNhaCungCap", "QLTaiKhoan",
			"QLPhanQuyen", "QLThongKe" };
	// Tạo mảng menuleft cho form
	private String arr_listmenu[] = { "Bán hàng", "Nhập hàng", "Món ăn", "Nguyên liệu", "Công thức", "Hóa đơn",
			"Hóa đơn nhập", "Khuyến mãi", "Khách Hàng", "Nhân viên", "Nhà cung cấp", "Tài khoản", "Phân quyền",
			"Thống kê" };
	// Tạo mảng icon cho menuleft
	private String arr_icon[] = { "src/Images/Icon/sell1-30.png", "src/Images/Icon/nhaphang-30.png",
			"src/Images/Icon/monan-30.png", "src/Images/Icon/nguyenlieu-30.png", "src/Images/Icon/congthuc-30.png",
			"src/Images/Icon/hoadon-30.png", "src/Images/Icon/hoadonnhap-30.png", "src/Images/Icon/khuyenmai-30.png",
			"src/Images/Icon/khachhang-30.png", "src/Images/Icon/nhanvien-30.png", "src/Images/Icon/nhacungcap-30.png",
			"src/Images/Icon/taikhoan-30.png", "src/Images/Icon/phanquyen1-30.png", "src/Images/Icon/thongke-30.png" };
	...
	// Tạo biến width_menu ,là chiều dài của menuleft , chiếm 13%
	public static int width_menu = width * 13 / 100;
	// Tạo biến width_content ,là chiều dài của phần nội dung , chiếm 87%
	public static int width_content = width * 87 / 100;
	// Tạo nhãn tiêu đề
	...
	public void initcomponent() throws Exception {
		...
		// Chú ý : phải set lệnh này trước visible nếu không thì lệnh không chạy và gây
		// lỗi
		setUndecorated(true);
		setVisible(true);
		// Panel chứa menuleft
		menu = menu();
		JScrollPane pane = new JScrollPane(menu, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
...
//        JPanel menu=new JPanel(new GridLayout(14, 1));
		...
		// JLabel logo=new JLabel(Tool.showIcon(width_menu, 200,
		// "src/Images/Icon/Logo-Design-removebg-preview.png"));

		// JLabel logo=new JLabel(Tool.showIcon(width_menu, 200,
		// "src/Images/Icon/ginger-tea.png"));
		...
		for (int i = 0; i < lbl_listmenu.length; i++) {
			lbl_listmenu[i] = new JLabel(arr_listmenu[i], Tool.showIcon(30, 30, arr_icon[i]), SwingConstants.LEADING);// thêm
																														// icon
																														// ráng
																														// kiếm
...
//            String maQuyen =TaiKhoanBUS.timKiemMaQuyenTheoTenTaiKhoan(Tool.maNVHienHanh);
	...
	private JPanel content() throws Exception {
		...
		// Tạo đè tất cả các Panel lên 1 Panel trung gian , sử dụng cơ chế setVisible
		// true fasle để xem từng bảng, sự kiện đã được thêm ở phía trên
		for (int i = 0; i < arr_listmenu.length; i++) {
			...
			case 3:
				...
				pn_content[i] = NguyenLieu;
				break;
			case 4:
				GUICongThuc CongThuc = new GUICongThuc();
				pn_content[i] = CongThuc;
				break;
			case 5:
	...
	private void logout() {
		...
		if (LoginGUI.taiKhoan != null) {
			int reply = JOptionPane.showConfirmDialog(getRootPane(),
					"Bạn có chắc muốn đăng xuất khỏi " + LoginGUI.taiKhoan + "?", "Chú ý", JOptionPane.YES_NO_OPTION);
