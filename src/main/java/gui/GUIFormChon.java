...
public class GUIFormChon extends JDialog {
	...
	public void docDBKhachHang() throws Exception {
		Table.setHeaders(Category.arr_kh);
	...
	public void docDBNhanVien() throws Exception {
		Table.setHeaders(Category.arr_nv);
