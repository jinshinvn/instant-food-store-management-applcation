...
public class GUIMonAn extends GUIFormContent {
	...
	// Tạo mảng tiêu đề
	public static final String array_MonAn[] = { "Mã", "Tên món", "Đơn vị tính", "Giá", "Hình ảnh", "Loại", "Số lượng" };
		...
		Luu.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent evt) {
				...
				if (a == JOptionPane.YES_OPTION) {
					...
					if (checkTextThem(txt_MonAn_Them[0].getText(), txt_MonAn_Them[1].getText(),
							cbDonViTinh_Them.getSelectedItem().toString(), txt_MonAn_Them[3].getText(),
							txt_MonAn_Them[4].getText(), cbLoai_Them.getSelectedItem().toString(),
							txt_MonAn_Them[6].getText())) {
						// Tạo đối tượng và truyền dữ liệu trực tiếp vào
						MonAnDTO DTO = new MonAnDTO(txt_MonAn_Them[0].getText(), txt_MonAn_Them[1].getText(),
								cbDonViTinh_Them.getSelectedItem().toString(),
								Integer.parseInt(txt_MonAn_Them[3].getText()), txt_MonAn_Them[4].getText(),
								cbLoai_Them.getSelectedItem().toString(), Integer.parseInt(txt_MonAn_Them[6].getText()),
								"Hiện");
	...
	private void Sua_Frame() {
		...
		txt_MonAn_Sua[4].setEditable(false); 
		JButton Luu = new JButton("Lưu");
		Luu.setBackground(Color.decode("#90CAF9"));
		Luu.setBounds(100, y, 100, 50);
		Luu.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent evt) {
				...
				if (a == JOptionPane.YES_OPTION) {
					if (checkTextSua(txt_MonAn_Sua[0].getText(), txt_MonAn_Sua[1].getText(),
							cbDonViTinh_Sua.getSelectedItem().toString(), txt_MonAn_Sua[3].getText(),
							txt_MonAn_Sua[4].getText(), cbLoai_Sua.getSelectedItem().toString(),
	...
	public boolean checkTextThem(String MaMonAn, String TenMonAn, String DonViTinh, String DonGia, String HinhAnh,
			String Loai, String SoLuong) {
		UIManager.put("OptionPane.messageFont", new FontUIResource(new Font("Segoe UI", 0, 20)));
		if (MaMonAn.equals("") || TenMonAn.equals("") || DonViTinh.equals("") || DonGia.equals("") || HinhAnh.equals("")
				|| Loai.equals("") || SoLuong.equals("")) {
	...
	public boolean checkTextSua(String MaMonAn, String TenMonAn, String DonViTinh, String DonGia, String HinhAnh,
			String Loai, String SoLuong) {
		UIManager.put("OptionPane.messageFont", new FontUIResource(new Font("Segoe UI", 0, 20)));
		if (MaMonAn.equals("") || TenMonAn.equals("") || DonViTinh.equals("") || DonGia.equals("") || HinhAnh.equals("")
				|| Loai.equals("") || SoLuong.equals("")) {
	...
	public void buttonLuu_Sua() {
		...
		MonAnDTO DTO = new MonAnDTO(txt_MonAn_Sua[0].getText(), txt_MonAn_Sua[1].getText(),
				cbDonViTinh_Sua.getSelectedItem().toString(), Integer.parseInt(txt_MonAn_Sua[3].getText()),
				txt_MonAn_Sua[4].getText(), cbLoai_Sua.getSelectedItem().toString(),
...
//         Set các textfield không edit được
	...
	public void txtSearchOnChange() {
		...
		setDataToTable(Tool.searchMA(Ten.getText(), donGia1, donGia2, soLuong1, soLuong2), table_MonAn); 
	}
	...
	public JPopupMenu createPopUp(int rowIndex, GUIMyTable Table) {
		...
		menuThem.setIcon(new ImageIcon(Dir.menuThemImg));
		menuSua = new JMenuItem("Sửa");
		menuSua.setIcon(new ImageIcon(Dir.menuSuaImg));
		menuXoa = new JMenuItem("Xóa");
		menuXoa.setIcon(new ImageIcon(Dir.menuXoaImg));
