...
public class GUIKhuyenMai extends GUIFormContent {
	...
	public static String array_KhuyenMai[] = { "Mã khuyến mãi", "Tên chương trình", "Tiền giảm", "Ngày bắt đầu",
			"Ngày kết thúc", "Nội dung" };
		...
		Luu.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent evt) {
				...
				if (a == JOptionPane.YES_OPTION) {
					if (checkTextThem(txt_KhuyenMai_Them[1].getText(), txt_KhuyenMai_Them[2].getText(),
							txt_KhuyenMai_Them[3].getText(), txt_KhuyenMai_Them[4].getText(),
							txt_KhuyenMai_Them[5].getText())) {
						KhuyenMaiDTO DTO = new KhuyenMaiDTO(txt_KhuyenMai_Them[0].getText(),
								txt_KhuyenMai_Them[1].getText(), Integer.parseInt(txt_KhuyenMai_Them[2].getText()),
								LocalDate.parse(txt_KhuyenMai_Them[3].getText()),
								LocalDate.parse(txt_KhuyenMai_Them[4].getText()), txt_KhuyenMai_Them[5].getText(),
								"Hiện");
	...
	private void Sua_Frame() {
		...
		Luu.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent evt) {
				...
				if (a == JOptionPane.YES_OPTION) {
					if (checkTextSua(txt_KhuyenMai_Sua[1].getText(), txt_KhuyenMai_Sua[2].getText(),
							txt_KhuyenMai_Sua[3].getText(), txt_KhuyenMai_Sua[4].getText(),
...
//        if (option == JOptionPane.YES_OPTION) {
		...
		KhuyenMaiDTO DTO = new KhuyenMaiDTO(txt_KhuyenMai_Sua[0].getText(), txt_KhuyenMai_Sua[1].getText(),
				Integer.parseInt(txt_KhuyenMai_Sua[2].getText()), LocalDate.parse(txt_KhuyenMai_Sua[3].getText()),
				LocalDate.parse(txt_KhuyenMai_Sua[4].getText()), txt_KhuyenMai_Sua[5].getText());
...
//        }
	...
	public void txtSearchOnChange() {
		...
		setDataToTable(Tool.searchKM(Ten.getText(), Tu_NgayBatDau.getText(), Den_NgayKetThuc.getText(), donGia1,
				donGia2, cbSearch.getSelectedItem().toString()), table_KhuyenMai); // chưa sửa xong hỏi Nguyên cái
																					// Textfield
	}
	...
	public boolean checkTextThem(String tenChuongTrinh, String tienGiamGia, String ngayBatDau, String ngayKetThuc,
			String noiDung) {
		UIManager.put("OptionPane.messageFont", new FontUIResource(new Font("Segoe UI", 0, 20)));
		if (tenChuongTrinh.equals("") || tienGiamGia.equals("") || noiDung.equals("") || ngayBatDau.equals("")
				|| ngayKetThuc.equals("")) {
	...
	public boolean checkTextSua(String tenChuongTrinh, String tienGiamGia, String noiDung, String ngayBatDau,
			String ngayKetThuc) {
		UIManager.put("OptionPane.messageFont", new FontUIResource(new Font("Segoe UI", 0, 20)));
		if (tenChuongTrinh.equals("") || tienGiamGia.equals("") || noiDung.equals("") || ngayBatDau.equals("")
				|| ngayKetThuc.equals("")) {
