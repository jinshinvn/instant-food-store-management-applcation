		...
		Luu.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent evt) {
				...
				if (a == JOptionPane.YES_OPTION) {
					if (checkTextThem(txt_TaiKhoan_Them[1].getText(), txt_TaiKhoan_Them[2].getText(),
							txt_TaiKhoan_Them[3].getText())) {
						TaiKhoanDTO DTO = new TaiKhoanDTO(txt_TaiKhoan_Them[0].getText(),
								txt_TaiKhoan_Them[1].getText(), txt_TaiKhoan_Them[2].getText(),
								txt_TaiKhoan_Them[3].getText(), "Hiện");
	...
	private void Sua_Frame() {
		...
		Luu.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent evt) {
				...
				if (a == JOptionPane.YES_OPTION) {
					if (checkTextSua(txt_TaiKhoan_Sua[1].getText(), txt_TaiKhoan_Sua[2].getText(),
...
//        if (option == JOptionPane.YES_OPTION) {
		...
		TaiKhoanDTO DTO = new TaiKhoanDTO(txt_TaiKhoan_Sua[0].getText(), txt_TaiKhoan_Sua[1].getText(),
				txt_TaiKhoan_Sua[2].getText(), txt_TaiKhoan_Sua[3].getText());
...
//    }
	...
	public void txtSearchOnChange() {
		...
		setDataToTable(Tool.searchTK(search.getText(), cbSearch.getSelectedItem().toString()), table_TaiKhoan); // chưa
																												// sửa
																												// xong
																												// hỏi
																												// Nguyên
	...
	public boolean checkTextThem(String maNhanVien, String maQuyen, String matKhau) {
		...
		if (maNhanVien.equals("") || maQuyen.equals("") || matKhau.equals("")) {
