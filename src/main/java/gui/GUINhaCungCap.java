...
public class GUINhaCungCap extends GUIFormContent {
	...
	protected JPanel Table() {
		...
		// Show menu
		ShowMenu(table_NhaCungCap);// Show menu
		...
		Luu.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent evt) {
				...
				if (a == JOptionPane.YES_OPTION) {
					...
					if (checkTextThem(txt_NhaCungCap_Them[1].getText(), txt_NhaCungCap_Them[2].getText(),
							txt_NhaCungCap_Them[3].getText(), txt_NhaCungCap_Them[4].getText())) {
						NhaCungCapDTO DTO = new NhaCungCapDTO(txt_NhaCungCap_Them[0].getText(),
								txt_NhaCungCap_Them[1].getText(), txt_NhaCungCap_Them[2].getText(),
								txt_NhaCungCap_Them[3].getText(), txt_NhaCungCap_Them[4].getText(), "Hiện");
	...
	private void Sua_Frame() {
		...
		Luu.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent evt) {
				...
				if (a == JOptionPane.YES_OPTION) {
					if (checkTextSua(txt_NhaCungCap_Sua[1].getText(), txt_NhaCungCap_Sua[2].getText(),
							txt_NhaCungCap_Sua[3].getText(), txt_NhaCungCap_Sua[4].getText())) {
...
//        if (option == JOptionPane.YES_OPTION) {
		...
		NhaCungCapDTO DTO = new NhaCungCapDTO(txt_NhaCungCap_Sua[0].getText(), txt_NhaCungCap_Sua[1].getText(),
				txt_NhaCungCap_Sua[2].getText(), txt_NhaCungCap_Sua[3].getText(), txt_NhaCungCap_Sua[4].getText());
...
//        }
	...
	public boolean checkTextThem(String tenNhaCungCap, String soDienThoai, String gmail, String diaChi) {
		...
		if (tenNhaCungCap.equals("") || soDienThoai.equals("") || gmail.equals("") || diaChi.equals("")) {
	...
	public void txtSearchOnChange() {
		...
		setDataToTable(Tool.searchNCC(search.getText(), cbSearch.getSelectedItem().toString()), table_NhaCungCap); // chưa
																													// sửa
																													// xong
																													// hỏi
																													// Nguyên
