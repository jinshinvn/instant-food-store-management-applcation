...
public class GUIKhachHang extends GUIFormContent {
	...
	private final JLabel label_KhachHang[] = new JLabel[Category.arr_kh.length];
	// Phần textfield của thêm
	private JTextField txt_KhachHang_Them[] = new JTextField[Category.arr_kh.length];
	// Phần textfield của sửa
	private JTextField txt_KhachHang_Sua[] = new JTextField[Category.arr_kh.length];
	...
	protected JPanel Table() {
		...
		// Tạo tiêu đề bảng
		table_KhachHang.setHeaders(Category.arr_kh);
		// Hàm đọc database
		docDB();
	...
	private void Them_Frame() {
		JFrame f = new JFrame();
		// Để cờ hiệu với giá trị 0 với ý nghĩa không được bấm ra khỏi Dialog trừ nút
		// Thoát
		cohieu = 0;
		...
		for (int i = 0; i < Category.arr_kh.length; i++) {
			label_KhachHang[i] = new JLabel(Category.arr_kh[i]);
			label_KhachHang[i].setBounds(100, y, 100, 30);
			Them_KhachHang.add(label_KhachHang[i]);
			// Tạo combobox
			if (i == 4) {
				cbGioiTinh_Them = new JComboBox(Category.arr_gend);
		...
		Luu.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent evt) {
				...
				if (a == JOptionPane.YES_OPTION) {
					if (checkTextThem(txt_KhachHang_Them[1].getText(), txt_KhachHang_Them[2].getText(),
							txt_KhachHang_Them[3].getText(), cbGioiTinh_Them.getSelectedItem().toString(),
							txt_KhachHang_Them[5].getText(), txt_KhachHang_Them[6].getText())) {
						KhachHangDTO DTO = new KhachHangDTO(txt_KhachHang_Them[0].getText(),
								txt_KhachHang_Them[1].getText(), txt_KhachHang_Them[2].getText(),
								txt_KhachHang_Them[3].getText(), cbGioiTinh_Them.getSelectedItem().toString(),
								txt_KhachHang_Them[5].getText(), Float.parseFloat(txt_KhachHang_Them[6].getText()),
								"Hiện");
	...
	private void Sua_Frame() {
		...
		for (int i = 0; i < Category.arr_kh.length; i++) {
			...
			// Tạo combobox
			if (i == 4) {
				cbGioiTinh_Sua = new JComboBox(Category.arr_gend);
		...
		Luu.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent evt) {
				...
				if (a == JOptionPane.YES_OPTION) {
					if (checkTextSua(txt_KhachHang_Sua[1].getText(), txt_KhachHang_Sua[2].getText(),
							txt_KhachHang_Sua[3].getText(), cbGioiTinh_Sua.getSelectedItem().toString(),
							txt_KhachHang_Sua[5].getText(), txt_KhachHang_Sua[6].getText())) {
...
//        if (option == JOptionPane.YES_OPTION) {
		...
		for (int j = 0; j < Category.arr_kh.length; j++) {
			if (j != 4)
		...
		KhachHangDTO DTO = new KhachHangDTO(txt_KhachHang_Sua[0].getText(), txt_KhachHang_Sua[1].getText(),
				txt_KhachHang_Sua[2].getText(), txt_KhachHang_Sua[3].getText(),
				cbGioiTinh_Sua.getSelectedItem().toString(), txt_KhachHang_Sua[5].getText(),
		...
		if (i == -1) {
			...
			for (int j = 0; j < Category.arr_kh.length; j++) {
				if (j != 4)
					...
					int k;
					for (k = 0; k < Category.arr_gend.length; k++)
						if (table_KhachHang.tb.getValueAt(i, j).toString().equals(Category.arr_gend[k]))
...
//        int x = 400;
//        cbSearch = new JComboBox<>(Category.arr_kh);
//        cbSearch.setBounds(5, 20, 150, 40);
//        lbsearch.add(cbSearch);
//
//        search = new JTextField();
//        search.setBorder(new TitledBorder(Category.arr_kh[0]));
...
//    }
	...
	public void txtSearchOnChange() {
		...
		setDataToTable(Tool.searchKH(Ten.getText(), donGia1, donGia2, cbSearch.getSelectedItem().toString()),
				table_KhachHang); // chưa sửa xong hỏi Nguyên cái Textfield
	}
	...
	public boolean checkTextThem(String hoKhachHang, String tenKhachHang, String gmail, String gioiTinh,
			String soDienThoai, String tongChiTieu) {
		UIManager.put("OptionPane.messageFont", new FontUIResource(new Font("Segoe UI", 0, 20)));
		if (hoKhachHang.equals("") || tenKhachHang.equals("") || gmail.equals("") || gioiTinh.equals("")
				|| soDienThoai.equals("") || tongChiTieu.equals("")) {
	...
	public boolean checkTextSua(String hoKhachHang, String tenKhachHang, String gmail, String gioiTinh,
			String soDienThoai, String tongChiTieu) {
		UIManager.put("OptionPane.messageFont", new FontUIResource(new Font("Segoe UI", 0, 20)));
		if (hoKhachHang.equals("") || tenKhachHang.equals("") || gmail.equals("") || gioiTinh.equals("")
				|| soDienThoai.equals("") || tongChiTieu.equals("")) {
